...
function CarpinteriaBanner() {
  return (
  <div className="relative w-full h-[570px] bg-amber-800 overflow-hidden flex items-center justify-center">
  {/* Fondo de madera (opcional) */}
  <Image
    src="/img/fondo-madera.jpg" // Si tenés una textura de madera separada
    width={1920}
    height={650}
  ...
  <div className="relative z-10 flex flex-col justify-center items-center text-white px-4 text-center">
    ...
    <Image
      ...
      width={200} // Ajustá según el tamaño que prefieras
      height={200}
